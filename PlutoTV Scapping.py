    ...
    for i in times:
        for li in i.find_all('li'):
            if re.search(r'\b\d+\s*hr\b', li.text) or re.search(r'\b\d+\s*min\b', li.text):
                time = li.text.strip()
            if re.search(r'PG', li.text) or re.search(r'^R$', li.text) or re.search(r'^TV-G$', li.text) or re.search(r'^NC-17$', li.text) or re.search(r'^Y$', li.text) or re.search(r'^TV-14$', li.text) or re.search(r'^MA$', li.text) or re.search(r'^TV-Y7$', li.text) or re.search(r'^PG-13$', li.text) or re.search(r'^TV-MA$', li.text) or re.search(r'^TV-PG$', li.text) or re.search(r'^G$', li.text) or re.search(r'^TV-Y$', li.text):
                rate = li.text.strip()
                if rate == "":
                    rate = "N/A"
            if re.search(r'^Comedy$', li.text) or re.search(r'^Horror$', li.text) or re.search(r'^Drama$', li.text) or re.search(r'^War$', li.text) or re.search(r'^Action & Adventure$', li.text) or re.search(r'Family', li.text) or re.search(r'^Thriller$', li.text) or re.search(r'^Sci-Fi$', li.text) or re.search(r'^Adventure$', li.text) or re.search(r'^Documentary$', li.text) or re.search(r'^Romance$', li.text) or re.search(r'^Accion$', li.text) or re.search(r'^Fantasy$', li.text) or re.search(r'^Sci-Fi & Fantasy$', li.text) or re.search(r'^Crime$', li.text) or re.search(r'^Western$', li.text) or re.search(r'^Anime$', li.text) or re.search(r'^Young Adult$', li.text) or re.search(r'^Faith & Spiritualityc', li.text) or re.search(r'^Gay & Lesbian$', li.text) or re.search(r'^Independent$', li.text) or re.search(r'^Entertainment$', li.text) or re.search(r'^Musical$', li.text) or re.search(r'^Other$', li.text) or re.search(r'^Thrillers$', li.text) or re.search(r'^Instructional & Educational$', li.text):
                gen = li.text.strip()
                if gen == "":
                    gen = "N/A"
